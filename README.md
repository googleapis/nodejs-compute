...
Note that autogenerated samples are available under [`samples/generated`](https://github.com/googleapis/nodejs-compute/tree/main/samples/generated/) and cover Compute Engine v1 API. 
