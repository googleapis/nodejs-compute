...
import type {Operation, Region, Subnetwork as SubnetworkType} from '../src';
...
describe('Subnetwork', () => {
  let Subnetwork: typeof SubnetworkType;
  let subnetwork: SubnetworkType;
  ...
  describe('instantiation', () => {
    ...
    it('should inherit from ServiceObject', () => {
      ...
      const calledWith = ((subnetwork as unknown) as FakeServiceObject)
        .calledWith_[0];
  ...
  describe('delete', () => {
    it('should make the correct API request', done => {
      subnetwork.request = function (reqOpts: DecorateRequestOptions): any {
