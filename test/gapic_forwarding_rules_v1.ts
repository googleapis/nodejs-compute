...
describe('v1.ForwardingRulesClient', () => {
    ...
    describe('aggregatedList', () => {
        it('invokes aggregatedList without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.AggregatedListForwardingRulesRequest());
            request.project = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.ForwardingRuleAggregatedList());
        ...
        it('invokes aggregatedList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.aggregatedList(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IForwardingRuleAggregatedList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteForwardingRuleRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetForwardingRuleRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.ForwardingRule());
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListForwardingRulesRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.ForwardingRuleList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IForwardingRuleList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetLabelsForwardingRuleRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('setTarget', () => {
        it('invokes setTarget without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetTargetForwardingRuleRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.setTarget as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
