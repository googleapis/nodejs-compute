...
describe('v1.ImagesClient', () => {
  ...
  describe('deprecate', () => {
    ...
    it('invokes deprecate without error using callback', async () => {
      ...
      client.innerApiCalls.deprecate = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.deprecate(
  ...
  describe('getFromFamily', () => {
    ...
    it('invokes getFromFamily without error using callback', async () => {
      ...
      client.innerApiCalls.getFromFamily = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.ImageList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IImageList | null
          ) => {
            if (err) {
              reject(err);
            } else {
