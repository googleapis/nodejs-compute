...
describe('v1.GlobalPublicDelegatedPrefixesClient', () => {
  ...
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        globalpublicdelegatedprefixesModule.v1
          .GlobalPublicDelegatedPrefixesClient.servicePath;
      assert(servicePath);
    });
    ...
    it('has apiEndpoint', () => {
      const apiEndpoint =
        globalpublicdelegatedprefixesModule.v1
          .GlobalPublicDelegatedPrefixesClient.apiEndpoint;
      assert(apiEndpoint);
    });
    ...
    it('has port', () => {
      const port =
        globalpublicdelegatedprefixesModule.v1
          .GlobalPublicDelegatedPrefixesClient.port;
      assert(port);
