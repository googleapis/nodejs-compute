...
describe('v1.TargetGrpcProxiesClient', () => {
  it('has servicePath', () => {
    const servicePath =
      targetgrpcproxiesModule.v1.TargetGrpcProxiesClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      targetgrpcproxiesModule.v1.TargetGrpcProxiesClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ITargetGrpcProxy | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.TargetGrpcProxyList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ITargetGrpcProxyList | null
          ) => {
            if (err) {
              reject(err);
            } else {
