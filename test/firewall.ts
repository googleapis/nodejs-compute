...
import type {Compute, Firewall as FirewallType, Operation} from '../src';
...
describe('Firewall', () => {
  let Firewall: typeof FirewallType;
  let firewall: FirewallType;
  ...
  describe('instantiation', () => {
    ...
    it('should inherit from ServiceObject', () => {
      ...
      const calledWith = ((firewall as unknown) as FakeServiceObject)
        .calledWith_[0];
  ...
  describe('setMetadata', () => {
    it('should make the correct API request', done => {
      ...
      firewall.request = function (reqOpts: DecorateRequestOptions): any {
