...
describe('v1.InstanceTemplatesClient', () => {
  it('has servicePath', () => {
    const servicePath =
      instancetemplatesModule.v1.InstanceTemplatesClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      instancetemplatesModule.v1.InstanceTemplatesClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.InstanceTemplateList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IInstanceTemplateList | null
          ) => {
            if (err) {
              reject(err);
            } else {
