...
describe('Network', () => {
  ...
  describe('createFirewall', () => {
    it('should make the correct call to Compute', done => {
      ...
      const config = ({a: 'b', c: 'd'} as unknown) as CreateFirewallOptions;
  ...
  describe('createSubnetwork', () => {
    it('should call region.createSubnetwork correctly', done => {
      ...
      const region = ({} as unknown) as RegionType;
      const config = {
        a: 'b',
        c: 'd',
        region: REGION_NAME,
  ...
  describe('getFirewalls', () => {
    it('should make the correct call to Compute', done => {
      const options = ({a: 'b', c: 'd'} as unknown) as GetResourcesOptions;
  ...
  describe('getFirewallsStream', () => {
    ...
    it('should return a stream', done => {
      const fakeStream = ({} as unknown) as ResourceStream<Firewall>;
  ...
  describe('getSubnetworksStream', () => {
    ...
    it('should return a stream', done => {
      const fakeStream = ({} as unknown) as ResourceStream<Subnetwork>;
