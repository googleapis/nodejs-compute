...
describe('v1.TargetTcpProxiesClient', () => {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.TargetTcpProxyList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ITargetTcpProxyList | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('setBackendService', () => {
    ...
    it('invokes setBackendService without error using callback', async () => {
      ...
      client.innerApiCalls.setBackendService = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
  ...
  describe('setProxyHeader', () => {
    ...
    it('invokes setProxyHeader without error using callback', async () => {
      ...
      client.innerApiCalls.setProxyHeader = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
