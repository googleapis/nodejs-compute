...
describe('v1.TargetInstancesClient', () => {
    ...
    describe('aggregatedList', () => {
        it('invokes aggregatedList without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.AggregatedListTargetInstancesRequest());
            request.project = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.TargetInstanceAggregatedList());
        ...
        it('invokes aggregatedList without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.aggregatedList(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.ITargetInstanceAggregatedList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.TargetInstance());
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListTargetInstancesRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.TargetInstanceList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.ITargetInstanceList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
