...
describe('v1.RegionHealthCheckServicesClient', () => {
  it('has servicePath', () => {
    const servicePath =
      regionhealthcheckservicesModule.v1.RegionHealthCheckServicesClient
        .servicePath;
    assert(servicePath);
  });
  ...
  it('has port', () => {
    const port =
      regionhealthcheckservicesModule.v1.RegionHealthCheckServicesClient.port;
    assert(port);
  ...
  it('should create a client with no option', () => {
    const client =
      new regionhealthcheckservicesModule.v1.RegionHealthCheckServicesClient();
    assert(client);
  });
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IHealthCheckService | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.HealthCheckServicesList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IHealthCheckServicesList | null
          ) => {
            if (err) {
              reject(err);
            } else {
