...
const fakeUtil = Object.assign({}, util, {
  maybeOptionsOrCallback: util.maybeOptionsOrCallback,
...
const fakePaginator = {
  paginator: {
    extend: function (Class: typeof Service, methods?: string[]) {
      if (Class.name !== 'Compute') {
        return;
      }
...
function FakeFirewall(this: {calledWith_: unknown[]}) {
...
function FakeHealthCheck(this: {calledWith_: unknown[]}) {
  // eslint-disable-next-line prefer-rest-params
  this.calledWith_ = slice.call(arguments);
...
function FakeImage(this: {calledWith_: unknown[]}) {
  // eslint-disable-next-line prefer-rest-params
  this.calledWith_ = slice.call(arguments);
...
function FakeNetwork(this: {calledWith_: unknown[]}) {
  // eslint-disable-next-line prefer-rest-params
  this.calledWith_ = slice.call(arguments);
...
function FakeProject(this: {calledWith_: unknown[]}) {
  // eslint-disable-next-line prefer-rest-params
  this.calledWith_ = slice.call(arguments);
...
function FakeRule(this: {calledWith_: unknown[]}) {
  // eslint-disable-next-line prefer-rest-params
  this.calledWith_ = slice.call(arguments);
...
describe('Compute', () => {
  let Compute: typeof ComputeType;
  let compute: ComputeType;
  ...
  before(function () {
    ...
    ({Compute} = proxyquire('../src/compute.js', {
      '@google-cloud/common': {
        Service: FakeService,
        util: fakeUtil,
      },
      ...
      './firewall.js': {Firewall: FakeFirewall},
      './health-check.js': {HealthCheck: FakeHealthCheck},
      './image.js': {Image: FakeImage},
      './network.js': {Network: FakeNetwork},
      './operation.js': {Operation: FakeOperation},
      './project.js': {Project: FakeProject},
      './region.js': {Region: FakeRegion},
      './rule.js': {Rule: FakeRule},
      './service.js': {Service: FakeServiceClass},
      './snapshot.js': {Snapshot: FakeSnapshot},
      './zone.js': {Zone: FakeZone},
    }));
  });
  ...
  describe('instantiation', () => {
    ...
    it('should inherit from Service', () => {
      ...
      const calledWith = ((compute as unknown) as FakeService).calledWith_[0];
  ...
  describe('createHealthCheck', () => {
    ...
    describe('success', () => {
      ...
      it('should create an HTTPS HealthCheck object', done => {
        ...
        compute.healthCheck = function (name_, options): any {
          assert.strictEqual(name_, name);
  ...
  describe('firewall', () => {
    ...
    it('should return a Firewall object', () => {
      ...
      assert.strictEqual(
        ((firewall as unknown) as ReturnType<typeof FakeFirewall>)
          .calledWith_[0],
        compute
      );
      assert.strictEqual(
  ...
  describe('getAddresses', () => {
    ...
    describe('success', () => {
      ...
      (apiResponse.items as Record<string, unknown>)[FULL_REGION_NAME] = {
        addresses: [address],
      };
  ...
  describe('healthCheck', () => {
    ...
    it('should return a HealthCheck object', () => {
      ...
      assert.strictEqual(
        ((healthCheck as unknown) as ReturnType<typeof FakeHealthCheck>)
          .calledWith_[0],
        compute
      );
      assert.strictEqual(
  ...
  describe('image', () => {
    ...
    it('should return an Image object', () => {
      ...
      assert.strictEqual(
        ((image as unknown) as ReturnType<typeof FakeImage>).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((image as unknown) as ReturnType<typeof FakeImage>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('network', () => {
    ...
    it('should return a Network object', () => {
      ...
      assert.strictEqual(
        ((network as unknown) as ReturnType<typeof FakeNetwork>).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((network as unknown) as ReturnType<typeof FakeNetwork>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('operation', () => {
    ...
    it('should return an Operation object', () => {
      ...
      assert.strictEqual(
        ((op as unknown) as ReturnType<typeof FakeOperation>).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((op as unknown) as ReturnType<typeof FakeOperation>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('project', () => {
    it('should return a Project object', () => {
      ...
      assert.strictEqual(
        ((project as unknown) as ReturnType<typeof FakeProject>).calledWith_[0],
        compute
      );
    });
  });
  ...
  describe('region', () => {
    ...
    it('should return a Region object', () => {
      ...
      assert.strictEqual(
        ((region as unknown) as ReturnType<typeof FakeRegion>).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((region as unknown) as ReturnType<typeof FakeRegion>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('rule', () => {
    ...
    it('should return a Rule object', () => {
      ...
      assert.strictEqual(
        ((rule as unknown) as ReturnType<typeof FakeRule>).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((rule as unknown) as ReturnType<typeof FakeRule>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('service', () => {
    ...
    it('should return a Service object', () => {
      ...
      assert.strictEqual(
        ((service as unknown) as FakeServiceClass).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((service as unknown) as FakeServiceClass).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('zone', () => {
    ...
    it('should return a Zone object', () => {
      ...
      assert.strictEqual(
        ((zone as unknown) as ReturnType<typeof FakeZone>).calledWith_[0],
        compute
      );
      assert.strictEqual(
        ((zone as unknown) as ReturnType<typeof FakeZone>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('execAfterOperation_', () => {
    const OPERATION = new events.EventEmitter() as Operation;
