...
describe('v1.RoutersClient', () => {
    ...
    it('invokes aggregatedList without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.aggregatedList(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRouterAggregatedList | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes getNatMappingInfo without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.getNatMappingInfo(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IVmEndpointNatMappingsList | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.RouterList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRouterList | null
          ) => {
            if (err) {
              reject(err);
            } else {
