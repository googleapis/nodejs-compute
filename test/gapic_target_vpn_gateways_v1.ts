...
describe('v1.TargetVpnGatewaysClient', () => {
  it('has servicePath', () => {
    const servicePath =
      targetvpngatewaysModule.v1.TargetVpnGatewaysClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      targetvpngatewaysModule.v1.TargetVpnGatewaysClient.apiEndpoint;
    assert(apiEndpoint);
  });
  ...
  describe('aggregatedList', () => {
    it('invokes aggregatedList without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.TargetVpnGatewayAggregatedList()
      );
    ...
    it('invokes aggregatedList without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.aggregatedList(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ITargetVpnGatewayAggregatedList | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ITargetVpnGateway | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.TargetVpnGatewayList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ITargetVpnGatewayList | null
          ) => {
            if (err) {
              reject(err);
            } else {
