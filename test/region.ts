...
function FakeAddress(this: {calledWith_: unknown[]}) {
...
function FakeSubnetwork(this: {calledWith_: unknown[]}) {
  // eslint-disable-next-line prefer-rest-params
  this.calledWith_ = [].slice.call(arguments);
...
describe('Region', () => {
  ...
  describe('instantiation', () => {
    ...
    it('should inherit from ServiceObject', () => {
      ...
      const calledWith = ((region as unknown) as FakeServiceObject)
        .calledWith_[0];
  ...
  describe('address', () => {
    ...
    it('should return an Address object', () => {
      ...
      assert.strictEqual(
        ((address as unknown) as ReturnType<typeof FakeAddress>).calledWith_[0],
        region
      );
      assert.strictEqual(
        ((address as unknown) as ReturnType<typeof FakeAddress>).calledWith_[1],
        NAME
      );
    });
  });
  ...
  describe('subnetwork', () => {
    ...
    it('should return a Subnetwork object', () => {
      ...
      assert.strictEqual(
        ((subnetwork as unknown) as ReturnType<typeof FakeSubnetwork>)
          .calledWith_[0],
        region
      );
      assert.strictEqual(
