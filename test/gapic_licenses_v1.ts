...
describe('v1.LicensesClient', () => {
    ...
    it('invokes get without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.get(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ILicense | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.LicensesListResponse()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.ILicensesListResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
