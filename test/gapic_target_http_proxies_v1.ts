...
describe('v1.TargetHttpProxiesClient', () => {
  ...
  describe('Common methods', () => {
    it('has servicePath', () => {
      const servicePath =
        targethttpproxiesModule.v1.TargetHttpProxiesClient.servicePath;
      assert(servicePath);
    });

    it('has apiEndpoint', () => {
      const apiEndpoint =
        targethttpproxiesModule.v1.TargetHttpProxiesClient.apiEndpoint;
      assert(apiEndpoint);
    });
  ...
  describe('get', () => {
    it('invokes get without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('GetTargetHttpProxyRequest', [
        'project',
      ]);
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue('GetTargetHttpProxyRequest', [
        'targetHttpProxy',
      ]);
      request.targetHttpProxy = defaultValue2;
      const expectedHeaderRequestParams = `project=${defaultValue1}&target_http_proxy=${defaultValue2}`;
  ...
  describe('patch', () => {
    it('invokes patch without error', async () => {
      ...
      const defaultValue1 = getTypeDefaultValue('PatchTargetHttpProxyRequest', [
        'project',
      ]);
      request.project = defaultValue1;
      const defaultValue2 = getTypeDefaultValue('PatchTargetHttpProxyRequest', [
        'targetHttpProxy',
      ]);
      request.targetHttpProxy = defaultValue2;
      const expectedHeaderRequestParams = `project=${defaultValue1}&target_http_proxy=${defaultValue2}`;
      ...
      const expectedResponse = [
        [
          ...
          generateSampleMessage(
            new protos.google.cloud.compute.v1.TargetHttpProxiesScopedList()
          ),
        ],
        [
          'tuple_key_2',
