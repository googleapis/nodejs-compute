...
describe('v1.RegionInstanceGroupManagersClient', () => {
    ...
    describe('applyUpdatesToInstances', () => {
        it('invokes applyUpdatesToInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ApplyUpdatesToInstancesRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('createInstances', () => {
        it('invokes createInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.CreateInstancesRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deleteInstances', () => {
        it('invokes deleteInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteInstancesRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('deletePerInstanceConfigs', () => {
        it('invokes deletePerInstanceConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeletePerInstanceConfigsRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.InstanceGroupManager());
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListRegionInstanceGroupManagersRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.RegionInstanceGroupManagerList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagerList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listErrors', () => {
        it('invokes listErrors without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListErrorsRegionInstanceGroupManagersRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.RegionInstanceGroupManagersListErrorsResponse());
        ...
        it('invokes listErrors without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listErrors(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagersListErrorsResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listManagedInstances', () => {
        it('invokes listManagedInstances without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListManagedInstancesRegionInstanceGroupManagersRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.RegionInstanceGroupManagersListInstancesResponse());
        ...
        it('invokes listManagedInstances without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listManagedInstances(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagersListInstancesResponse|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listPerInstanceConfigs', () => {
        it('invokes listPerInstanceConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListPerInstanceConfigsRegionInstanceGroupManagersRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.RegionInstanceGroupManagersListInstanceConfigsResp());
        ...
        it('invokes listPerInstanceConfigs without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.listPerInstanceConfigs(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagersListInstanceConfigsResp|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('patchPerInstanceConfigs', () => {
        it('invokes patchPerInstanceConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchPerInstanceConfigsRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('resize', () => {
        it('invokes resize without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ResizeRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('setInstanceTemplate', () => {
        it('invokes setInstanceTemplate without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetInstanceTemplateRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('setTargetPools', () => {
        it('invokes setTargetPools without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetTargetPoolsRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('updatePerInstanceConfigs', () => {
        it('invokes updatePerInstanceConfigs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.UpdatePerInstanceConfigsRegionInstanceGroupManagerRequest());
            request.project = '';
            const expectedHeaderRequestParams = "project=";
            const expectedOptions = {
                otherArgs: {
