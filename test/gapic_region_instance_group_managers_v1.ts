...
describe('v1.RegionInstanceGroupManagersClient', () => {
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.RegionInstanceGroupManagerList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagerList | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listErrors without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listErrors(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagersListErrorsResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listManagedInstances without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listManagedInstances(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagersListInstancesResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
    ...
    it('invokes listPerInstanceConfigs without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.listPerInstanceConfigs(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IRegionInstanceGroupManagersListInstanceConfigsResp | null
          ) => {
            if (err) {
              reject(err);
            } else {
