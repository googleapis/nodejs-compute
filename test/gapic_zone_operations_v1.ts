...
describe('v1.ZoneOperationsClient', () => {
  it('has servicePath', () => {
    const servicePath =
      zoneoperationsModule.v1.ZoneOperationsClient.servicePath;
    assert(servicePath);
  });

  it('has apiEndpoint', () => {
    const apiEndpoint =
      zoneoperationsModule.v1.ZoneOperationsClient.apiEndpoint;
    assert(apiEndpoint);
  });
    ...
    it('invokes delete without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.delete(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IDeleteZoneOperationResponse | null
          ) => {
            if (err) {
              reject(err);
            } else {
