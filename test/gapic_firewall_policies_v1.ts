...
describe('v1.FirewallPoliciesClient', () => {
    ...
    describe('addAssociation', () => {
        it('invokes addAssociation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.AddAssociationFirewallPolicyRequest());
    ...
    describe('addRule', () => {
        it('invokes addRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.AddRuleFirewallPolicyRequest());
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "firewall_policy=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('cloneRules', () => {
        it('invokes cloneRules without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.CloneRulesFirewallPolicyRequest());
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "firewall_policy=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('getAssociation', () => {
        it('invokes getAssociation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetAssociationFirewallPolicyRequest());
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "firewall_policy=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetIamPolicyFirewallPolicyRequest());
            request.resource = '';
    ...
    describe('getRule', () => {
        it('invokes getRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetRuleFirewallPolicyRequest());
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "firewall_policy=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.InsertFirewallPolicyRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.Operation());
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListFirewallPoliciesRequest());
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.FirewallPolicyList());
        ...
        it('invokes list without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.list(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IFirewallPolicyList|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('listAssociations', () => {
        it('invokes listAssociations without error', async () => {
            ...
            const expectedOptions = {};
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.FirewallPoliciesListAssociationsResponse());
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listAssociations as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('move', () => {
        it('invokes move without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.MoveFirewallPolicyRequest());
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "firewall_policy=";
            const expectedOptions = {
                otherArgs: {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.move as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('patchRule', () => {
        it('invokes patchRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchRuleFirewallPolicyRequest());
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "firewall_policy=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetIamPolicyFirewallPolicyRequest());
            request.resource = '';
            const expectedHeaderRequestParams = "resource=";
            const expectedOptions = {
                otherArgs: {
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.TestIamPermissionsFirewallPolicyRequest());
            request.resource = '';
            const expectedHeaderRequestParams = "resource=";
            const expectedOptions = {
                otherArgs: {
