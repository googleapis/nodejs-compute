...
describe('v1.VpnGatewaysClient', () => {
  ...
  describe('aggregatedList', () => {
    it('invokes aggregatedList without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.VpnGatewayAggregatedList()
      );
    ...
    it('invokes aggregatedList without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.aggregatedList(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IVpnGatewayAggregatedList | null
          ) => {
            if (err) {
              reject(err);
            } else {
  ...
  describe('getStatus', () => {
    ...
    it('invokes getStatus without error using callback', async () => {
      ...
      client.innerApiCalls.getStatus = stubSimpleCallWithCallback(
        expectedResponse
      );
      const promise = new Promise((resolve, reject) => {
        client.getStatus(
  ...
  describe('list', () => {
    it('invokes list without error', async () => {
      ...
      const expectedResponse = generateSampleMessage(
        new protos.google.cloud.compute.v1.VpnGatewayList()
      );
    ...
    it('invokes list without error using callback', async () => {
      ...
      const promise = new Promise((resolve, reject) => {
        client.list(
          ...
          (
            err?: Error | null,
            result?: protos.google.cloud.compute.v1.IVpnGatewayList | null
          ) => {
            if (err) {
              reject(err);
            } else {
