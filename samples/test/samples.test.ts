...
describe('samples', () => {
  describe('quickstart', () => {
    ...
    it('should run the quickstart', () => {
      ...
      assert.match(output.toString(), /Virtual machine created!/);
    });
  });
  ...
  describe('lifecycle', () => {
    ...
    it('should list the VMs', () => {
      ...
      assert.match(output.toString(), /Found \d+ VMs!/);
    });

    it('should delete the VM', () => {
      const output = execSync(`node deleteVM ${name}`);
      assert.match(output.toString(), /VM deleted!/);
    });
  });
  ...
  describe('start-up script', () => {
    ...
    it('should create vm with startup script', function (done) {
      ...
      startupScript.on('close', (code: number) => {
