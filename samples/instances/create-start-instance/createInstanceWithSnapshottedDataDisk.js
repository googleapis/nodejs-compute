...
/**
 * Creates a new VM instance with Debian 10 operating system and data disk created from snapshot.
 *
...
function main(projectId, zone, instanceName, snapshotLink) {
  ...
  // Creates a new VM instance with Debian 10 operating system and data disk created from snapshot.
  async function createInstanceWithSnapshottedDataDisk() {
  ...
  createInstanceWithSnapshottedDataDisk();
