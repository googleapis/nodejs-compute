...
export class MachineTypesClient {
  ...
  aggregatedList(
      ...
      options?: CallOptions):
      Promise<[
        protos.google.cloud.compute.v1.IMachineTypeAggregatedList,
        protos.google.cloud.compute.v1.IAggregatedListMachineTypesRequest|undefined, {}|undefined
      ]>;
  aggregatedList(
      request: protos.google.cloud.compute.v1.IAggregatedListMachineTypesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IMachineTypeAggregatedList,
          protos.google.cloud.compute.v1.IAggregatedListMachineTypesRequest|null|undefined,
          {}|null|undefined>): void;
  aggregatedList(
      request: protos.google.cloud.compute.v1.IAggregatedListMachineTypesRequest,
      callback: Callback<
 ...
 *   The first element of the array is an object representing [MachineTypeAggregatedList]{@link google.cloud.compute.v1.MachineTypeAggregatedList}.
 *   Please see the
 ...
 */
  ...
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListMachineTypesRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.compute.v1.IListMachineTypesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IMachineTypeList,
          protos.google.cloud.compute.v1.IListMachineTypesRequest|null|undefined,
          {}|null|undefined>): void;
  list(
      request: protos.google.cloud.compute.v1.IListMachineTypesRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [MachineTypeList]{@link google.cloud.compute.v1.MachineTypeList}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
