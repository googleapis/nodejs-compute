 ...
 */
  ...
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListInterconnectLocationsRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.compute.v1.IListInterconnectLocationsRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IInterconnectLocationList,
          protos.google.cloud.compute.v1.IListInterconnectLocationsRequest|null|undefined,
          {}|null|undefined>): void;
  list(
      request: protos.google.cloud.compute.v1.IListInterconnectLocationsRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [InterconnectLocationList]{@link google.cloud.compute.v1.InterconnectLocationList}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
