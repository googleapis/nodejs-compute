 ...
 */
  ...
  list(
      ...
      Promise<[
        ...
        protos.google.cloud.compute.v1.IListRegionDiskTypesRequest|undefined, {}|undefined
      ]>;
  list(
      request: protos.google.cloud.compute.v1.IListRegionDiskTypesRequest,
      options: CallOptions,
      callback: Callback<
          protos.google.cloud.compute.v1.IRegionDiskTypeList,
          protos.google.cloud.compute.v1.IListRegionDiskTypesRequest|null|undefined,
          {}|null|undefined>): void;
  list(
      request: protos.google.cloud.compute.v1.IListRegionDiskTypesRequest,
      callback: Callback<
 ...
 *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
 * @returns {Promise} - The promise which resolves to an array.
 *   The first element of the array is an object representing [RegionDiskTypeList]{@link google.cloud.compute.v1.RegionDiskTypeList}.
 *   Please see the
 *   [documentation](https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods)
 *   for more details and examples.
 * @example
