...
import type {BaseOptions, IPVersion, NetworkTier} from './interfaces';
import type {OperationCallback} from './operation';
import type {Region} from './region';

export interface CreateAddressOptions extends BaseOptions {
  address?: string;
  prefixLength?: number;
 ...
 */
export class Address extends ServiceObject {
  name: string;
  region: Region;
