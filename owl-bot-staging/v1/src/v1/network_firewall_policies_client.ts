...
export class NetworkFirewallPoliciesClient {
  ...
  initialize() {
    ...
    const networkFirewallPoliciesStubMethods =
        ['addAssociation', 'addRule', 'cloneRules', 'delete', 'get', 'getAssociation', 'getIamPolicy', 'getRule', 'insert', 'list', 'patch', 'patchRule', 'removeAssociation', 'removeRule', 'setIamPolicy', 'testIamPermissions'];
