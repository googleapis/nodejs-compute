 ...
 */
  aggregatedListAsync(
      ...
      options?: CallOptions):
    AsyncIterable<[string, protos.google.cloud.compute.v1.IForwardingRulesScopedList]>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.aggregatedList.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<[string, protos.google.cloud.compute.v1.IForwardingRulesScopedList]>;
  }
 /**
 ...
 */
  ...
  list(
      ...
      callback: PaginationCallback<
          ...
          protos.google.cloud.compute.v1.IForwardingRule>): void;
  list(
      request: protos.google.cloud.compute.v1.IListForwardingRulesRequest,
      callback: PaginationCallback<
          protos.google.cloud.compute.v1.IListForwardingRulesRequest,
