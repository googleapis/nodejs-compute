...
export class BackendServicesClient {
  ...
  initialize() {
    ...
    const backendServicesStubMethods =
        ['addSignedUrlKey', 'aggregatedList', 'delete', 'deleteSignedUrlKey', 'get', 'getHealth', 'getIamPolicy', 'insert', 'list', 'patch', 'setEdgeSecurityPolicy', 'setIamPolicy', 'setSecurityPolicy', 'update'];
