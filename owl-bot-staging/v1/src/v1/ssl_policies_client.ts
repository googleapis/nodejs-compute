...
export class SslPoliciesClient {
  ...
  initialize() {
    ...
    const sslPoliciesStubMethods =
        ['aggregatedList', 'delete', 'get', 'insert', 'list', 'listAvailableFeatures', 'patch'];
 ...
 */
  aggregatedListAsync(
      ...
      options?: CallOptions):
    AsyncIterable<[string, protos.google.cloud.compute.v1.ISslPoliciesScopedList]>{
    request = request || {};
    options = options || {};
    options.otherArgs = options.otherArgs || {};
    options.otherArgs.headers = options.otherArgs.headers || {};
    ...
    return this.descriptors.page.aggregatedList.asyncIterate(
      ...
      request as {},
      callSettings
    ) as AsyncIterable<[string, protos.google.cloud.compute.v1.ISslPoliciesScopedList]>;
  }
 /**
