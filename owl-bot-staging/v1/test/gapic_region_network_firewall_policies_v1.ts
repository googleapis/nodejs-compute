  ...
  afterEach(() => {
    ...
    describe('addAssociation', () => {
        it('invokes addAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddAssociationRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddAssociationRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('AddAssociationRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
    ...
    describe('addRule', () => {
        it('invokes addRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddRuleRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddRuleRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('AddRuleRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('cloneRules', () => {
        it('invokes cloneRules without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CloneRulesRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('CloneRulesRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('CloneRulesRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getAssociation', () => {
        it('invokes getAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAssociationRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetAssociationRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetAssociationRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getEffectiveFirewalls', () => {
        it('invokes getEffectiveFirewalls without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetEffectiveFirewallsRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetEffectiveFirewallsRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIamPolicyRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIamPolicyRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetIamPolicyRegionNetworkFirewallPolicyRequest', ['resource']);
    ...
    describe('getRule', () => {
        it('invokes getRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRuleRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetRuleRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetRuleRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('PatchRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('patchRule', () => {
        it('invokes patchRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchRuleRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchRuleRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('PatchRuleRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('removeAssociation', () => {
        it('invokes removeAssociation without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveAssociationRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemoveAssociationRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RemoveAssociationRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('removeRule', () => {
        it('invokes removeRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveRuleRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemoveRuleRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RemoveRuleRegionNetworkFirewallPolicyRequest', ['firewallPolicy']);
            request.firewallPolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&firewall_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetIamPolicyRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetIamPolicyRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetIamPolicyRegionNetworkFirewallPolicyRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TestIamPermissionsRegionNetworkFirewallPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('TestIamPermissionsRegionNetworkFirewallPolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('TestIamPermissionsRegionNetworkFirewallPolicyRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRegionNetworkFirewallPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListRegionNetworkFirewallPoliciesRequest', ['region']);
            request.region = defaultValue2;
