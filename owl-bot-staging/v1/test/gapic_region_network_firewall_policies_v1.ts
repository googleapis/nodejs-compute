  ...
  afterEach(() => {
    ...
    describe('cloneRules', () => {
        it('invokes cloneRules without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.CloneRulesRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&firewall_policy=";
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&firewall_policy=";
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&firewall_policy=";
    ...
    describe('getAssociation', () => {
        it('invokes getAssociation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetAssociationRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&firewall_policy=";
    ...
    describe('getEffectiveFirewalls', () => {
        it('invokes getEffectiveFirewalls without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.RegionNetworkFirewallPoliciesGetEffectiveFirewallsResponse());
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetIamPolicyRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.resource = '';
    ...
    describe('getRule', () => {
        it('invokes getRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetRuleRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&firewall_policy=";
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.InsertRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            const expectedHeaderRequestParams = "project=&region=";
            const expectedOptions = {
    ...
    describe('removeRule', () => {
        it('invokes removeRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.RemoveRuleRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&firewall_policy=";
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetIamPolicyRegionNetworkFirewallPolicyRequest());
            request.project = '';
            request.region = '';
            request.resource = '';
            const expectedHeaderRequestParams = "project=&region=&resource=";
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListRegionNetworkFirewallPoliciesRequest());
            request.project = '';
            request.region = '';
            const expectedHeaderRequestParams = "project=&region=";
            const expectedOptions = {
