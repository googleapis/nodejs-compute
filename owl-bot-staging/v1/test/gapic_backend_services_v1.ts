  ...
  afterEach(() => {
    ...
    describe('addSignedUrlKey', () => {
        it('invokes addSignedUrlKey without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&backend_service=";
    ...
    describe('setEdgeSecurityPolicy', () => {
        it('invokes setEdgeSecurityPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetEdgeSecurityPolicyBackendServiceRequest());
            request.project = '';
            request.backendService = '';
            const expectedHeaderRequestParams = "project=&backend_service=";
            const expectedOptions = {
            ...
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            assert((client.innerApiCalls.setEdgeSecurityPolicy as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetIamPolicyBackendServiceRequest());
            request.project = '';
            request.resource = '';
            const expectedHeaderRequestParams = "project=&resource=";
            const expectedOptions = {
