  ...
  afterEach(() => {
    ...
    describe('addSignedUrlKey', () => {
        it('invokes addSignedUrlKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddSignedUrlKeyBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddSignedUrlKeyBackendServiceRequest', ['backendService']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('deleteSignedUrlKey', () => {
        it('invokes deleteSignedUrlKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSignedUrlKeyBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteSignedUrlKeyBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getHealth', () => {
        it('invokes getHealth without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetHealthBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetHealthBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIamPolicyBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIamPolicyBackendServiceRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertBackendServiceRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setEdgeSecurityPolicy', () => {
        it('invokes setEdgeSecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetEdgeSecurityPolicyBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetEdgeSecurityPolicyBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetIamPolicyBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetIamPolicyBackendServiceRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('setSecurityPolicy', () => {
        it('invokes setSecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetSecurityPolicyBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetSecurityPolicyBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateBackendServiceRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateBackendServiceRequest', ['backendService']);
            request.backendService = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_service=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListBackendServicesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBackendServicesRequest', ['project']);
            request.project = defaultValue1;
