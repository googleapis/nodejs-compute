  ...
  afterEach(() => {
    ...
    describe('attachNetworkEndpoints', () => {
        it('invokes attachNetworkEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AttachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network_endpoint_group=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('detachNetworkEndpoints', () => {
        it('invokes detachNetworkEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DetachNetworkEndpointsGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network_endpoint_group=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetGlobalNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network_endpoint_group=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertGlobalNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListGlobalNetworkEndpointGroupsRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('listNetworkEndpoints', () => {
        it('invokes listNetworkEndpoints without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListNetworkEndpointsGlobalNetworkEndpointGroupsRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue2;
