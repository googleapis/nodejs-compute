  ...
  afterEach(() => {
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRegionInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetRegionInstanceGroupRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetRegionInstanceGroupRequest', ['instanceGroup']);
    ...
    describe('setNamedPorts', () => {
        it('invokes setNamedPorts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetNamedPortsRegionInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetNamedPortsRegionInstanceGroupRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetNamedPortsRegionInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&instance_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRegionInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListRegionInstanceGroupsRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListInstancesRegionInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListInstancesRegionInstanceGroupsRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('ListInstancesRegionInstanceGroupsRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
