  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteNetworkEdgeSecurityServiceRequest());
            request.project = '';
            request.region = '';
            request.networkEdgeSecurityService = '';
            const expectedHeaderRequestParams = "project=&region=&network_edge_security_service=";
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetNetworkEdgeSecurityServiceRequest());
            request.project = '';
            request.region = '';
            request.networkEdgeSecurityService = '';
            const expectedHeaderRequestParams = "project=&region=&network_edge_security_service=";
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.NetworkEdgeSecurityService());
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchNetworkEdgeSecurityServiceRequest());
            request.project = '';
            request.region = '';
            request.networkEdgeSecurityService = '';
            const expectedHeaderRequestParams = "project=&region=&network_edge_security_service=";
