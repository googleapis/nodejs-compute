  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteTargetSslProxyRequest', ['targetSslProxy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTargetSslProxyRequest', ['targetSslProxy']);
            request.targetSslProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_ssl_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('setBackendService', () => {
        it('invokes setBackendService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetBackendServiceTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetBackendServiceTargetSslProxyRequest', ['targetSslProxy']);
            request.targetSslProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_ssl_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setCertificateMap', () => {
        it('invokes setCertificateMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetCertificateMapTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetCertificateMapTargetSslProxyRequest', ['targetSslProxy']);
            request.targetSslProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_ssl_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setProxyHeader', () => {
        it('invokes setProxyHeader without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetProxyHeaderTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetProxyHeaderTargetSslProxyRequest', ['targetSslProxy']);
            request.targetSslProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_ssl_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setSslCertificates', () => {
        it('invokes setSslCertificates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetSslCertificatesTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetSslCertificatesTargetSslProxyRequest', ['targetSslProxy']);
            request.targetSslProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_ssl_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setSslPolicy', () => {
        it('invokes setSslPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetSslPolicyTargetSslProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetSslPolicyTargetSslProxyRequest', ['targetSslProxy']);
            request.targetSslProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_ssl_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetSslProxiesRequest', ['project']);
            request.project = defaultValue1;
