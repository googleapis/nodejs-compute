  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&region=&target_https_proxy=";
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchRegionTargetHttpsProxyRequest());
            request.project = '';
            request.region = '';
            request.targetHttpsProxy = '';
            const expectedHeaderRequestParams = "project=&region=&target_https_proxy=";
