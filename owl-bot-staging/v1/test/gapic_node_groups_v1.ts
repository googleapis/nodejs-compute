  ...
  afterEach(() => {
    ...
    describe('addNodes', () => {
        it('invokes addNodes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddNodesNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddNodesNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('AddNodesNodeGroupRequest', ['nodeGroup']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteNodeGroupRequest', ['nodeGroup']);
            request.nodeGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&node_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('deleteNodes', () => {
        it('invokes deleteNodes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteNodesNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteNodesNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteNodesNodeGroupRequest', ['nodeGroup']);
            request.nodeGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&node_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetNodeGroupRequest', ['nodeGroup']);
            request.nodeGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&node_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIamPolicyNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIamPolicyNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetIamPolicyNodeGroupRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('PatchNodeGroupRequest', ['nodeGroup']);
            request.nodeGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&node_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetIamPolicyNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetIamPolicyNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetIamPolicyNodeGroupRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('setNodeTemplate', () => {
        it('invokes setNodeTemplate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetNodeTemplateNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetNodeTemplateNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetNodeTemplateNodeGroupRequest', ['nodeGroup']);
            request.nodeGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&node_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TestIamPermissionsNodeGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('TestIamPermissionsNodeGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('TestIamPermissionsNodeGroupRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListNodeGroupsRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNodeGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListNodeGroupsRequest', ['zone']);
            request.zone = defaultValue2;
    ...
    describe('listNodes', () => {
        it('invokes listNodes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNodesNodeGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListNodesNodeGroupsRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('ListNodesNodeGroupsRequest', ['nodeGroup']);
            request.nodeGroup = defaultValue3;
