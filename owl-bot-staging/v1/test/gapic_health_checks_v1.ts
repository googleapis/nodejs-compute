  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteHealthCheckRequest', ['healthCheck']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetHealthCheckRequest', ['healthCheck']);
            request.healthCheck = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&health_check=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertHealthCheckRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchHealthCheckRequest', ['healthCheck']);
            request.healthCheck = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&health_check=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateHealthCheckRequest', ['healthCheck']);
            request.healthCheck = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&health_check=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListHealthChecksRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListHealthChecksRequest', ['project']);
            request.project = defaultValue1;
