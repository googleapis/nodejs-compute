  ...
  afterEach(() => {
    ...
    describe('setCertificateMap', () => {
        it('invokes setCertificateMap without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetCertificateMapTargetHttpsProxyRequest());
            request.project = '';
            request.targetHttpsProxy = '';
            const expectedHeaderRequestParams = "project=&target_https_proxy=";
            const expectedOptions = {
            ...
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            assert((client.innerApiCalls.setCertificateMap as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
