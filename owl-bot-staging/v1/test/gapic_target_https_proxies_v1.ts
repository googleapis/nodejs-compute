  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteTargetHttpsProxyRequest', ['targetHttpsProxy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setCertificateMap', () => {
        it('invokes setCertificateMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetCertificateMapTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetCertificateMapTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setQuicOverride', () => {
        it('invokes setQuicOverride without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetQuicOverrideTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetQuicOverrideTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setSslCertificates', () => {
        it('invokes setSslCertificates without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetSslCertificatesTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetSslCertificatesTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setSslPolicy', () => {
        it('invokes setSslPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetSslPolicyTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetSslPolicyTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setUrlMap', () => {
        it('invokes setUrlMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetUrlMapTargetHttpsProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetUrlMapTargetHttpsProxyRequest', ['targetHttpsProxy']);
            request.targetHttpsProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_https_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListTargetHttpsProxiesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetHttpsProxiesRequest', ['project']);
            request.project = defaultValue1;
