  ...
  afterEach(() => {
    ...
    describe('addSignedUrlKey', () => {
        it('invokes addSignedUrlKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddSignedUrlKeyBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddSignedUrlKeyBackendBucketRequest', ['backendBucket']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteBackendBucketRequest', ['backendBucket']);
            request.backendBucket = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_bucket=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('deleteSignedUrlKey', () => {
        it('invokes deleteSignedUrlKey without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSignedUrlKeyBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteSignedUrlKeyBackendBucketRequest', ['backendBucket']);
            request.backendBucket = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_bucket=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetBackendBucketRequest', ['backendBucket']);
            request.backendBucket = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_bucket=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertBackendBucketRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchBackendBucketRequest', ['backendBucket']);
            request.backendBucket = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_bucket=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setEdgeSecurityPolicy', () => {
        it('invokes setEdgeSecurityPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetEdgeSecurityPolicyBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetEdgeSecurityPolicyBackendBucketRequest', ['backendBucket']);
            request.backendBucket = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_bucket=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateBackendBucketRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateBackendBucketRequest', ['backendBucket']);
            request.backendBucket = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&backend_bucket=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListBackendBucketsRequest', ['project']);
            request.project = defaultValue1;
