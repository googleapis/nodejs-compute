  ...
  afterEach(() => {
    ...
    describe('disableXpnHost', () => {
        it('invokes disableXpnHost without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DisableXpnHostProjectRequest', ['project']);
    ...
    describe('disableXpnResource', () => {
        it('invokes disableXpnResource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DisableXpnResourceProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('enableXpnHost', () => {
        it('invokes enableXpnHost without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('EnableXpnHostProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('enableXpnResource', () => {
        it('invokes enableXpnResource without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('EnableXpnResourceProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getXpnHost', () => {
        it('invokes getXpnHost without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetXpnHostProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Project()
    ...
    describe('moveDisk', () => {
        it('invokes moveDisk without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('MoveDiskProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('moveInstance', () => {
        it('invokes moveInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('MoveInstanceProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setCommonInstanceMetadata', () => {
        it('invokes setCommonInstanceMetadata without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetCommonInstanceMetadataProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setDefaultNetworkTier', () => {
        it('invokes setDefaultNetworkTier without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetDefaultNetworkTierProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setUsageExportBucket', () => {
        it('invokes setUsageExportBucket without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetUsageExportBucketProjectRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('getXpnResources', () => {
        it('invokes getXpnResources without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetXpnResourcesProjectsRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('listXpnHosts', () => {
        it('invokes listXpnHosts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListXpnHostsProjectsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;const expectedResponse = [
