  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteMachineImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteMachineImageRequest', ['machineImage']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetMachineImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetMachineImageRequest', ['machineImage']);
            request.machineImage = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&machine_image=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IMachineImage|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIamPolicyMachineImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIamPolicyMachineImageRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertMachineImageRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetIamPolicyMachineImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetIamPolicyMachineImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TestIamPermissionsMachineImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('TestIamPermissionsMachineImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListMachineImagesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.MachineImage()),
              generateSampleMessage(new protos.google.cloud.compute.v1.MachineImage()),
              generateSampleMessage(new protos.google.cloud.compute.v1.MachineImage()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.compute.v1.MachineImage) => {
