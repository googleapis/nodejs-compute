  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteImageRequest', ['image']);
    ...
    describe('deprecate', () => {
        it('invokes deprecate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeprecateImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeprecateImageRequest', ['image']);
            request.image = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&image=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetImageRequest', ['image']);
            request.image = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&image=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getFromFamily', () => {
        it('invokes getFromFamily without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetFromFamilyImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetFromFamilyImageRequest', ['family']);
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIamPolicyImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIamPolicyImageRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertImageRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchImageRequest', ['image']);
            request.image = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&image=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetIamPolicyImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetIamPolicyImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetLabelsImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetLabelsImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TestIamPermissionsImageRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('TestIamPermissionsImageRequest', ['resource']);
            request.resource = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&resource=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListImagesRequest', ['project']);
            request.project = defaultValue1;
