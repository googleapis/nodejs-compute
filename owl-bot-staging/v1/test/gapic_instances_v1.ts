  ...
  afterEach(() => {
    ...
    describe('resume', () => {
        it('invokes resume without error', async () => {
            ...
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            assert((client.innerApiCalls.resume as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('suspend', () => {
        it('invokes suspend without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SuspendInstanceRequest());
            request.project = '';
            request.zone = '';
            request.instance = '';
            const expectedHeaderRequestParams = "project=&zone=&instance=";
            ...
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            assert((client.innerApiCalls.suspend as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listReferrers', () => {
        ...
        it('uses async iteration with listReferrers with error', async () => {
            ...
            request.zone = '';
            request.instance = '';
            const expectedHeaderRequestParams = "project=&zone=&instance=";const expectedError = new Error('expected');
