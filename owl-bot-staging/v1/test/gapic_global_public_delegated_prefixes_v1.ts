  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteGlobalPublicDelegatedPrefixeRequest', ['publicDelegatedPrefix']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetGlobalPublicDelegatedPrefixeRequest', ['publicDelegatedPrefix']);
            request.publicDelegatedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&public_delegated_prefix=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchGlobalPublicDelegatedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchGlobalPublicDelegatedPrefixeRequest', ['publicDelegatedPrefix']);
            request.publicDelegatedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&public_delegated_prefix=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListGlobalPublicDelegatedPrefixesRequest', ['project']);
            request.project = defaultValue1;
