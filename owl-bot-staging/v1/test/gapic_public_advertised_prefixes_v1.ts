  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeletePublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeletePublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetPublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            request.publicAdvertisedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&public_advertised_prefix=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchPublicAdvertisedPrefixeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchPublicAdvertisedPrefixeRequest', ['publicAdvertisedPrefix']);
            request.publicAdvertisedPrefix = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&public_advertised_prefix=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPublicAdvertisedPrefixesRequest', ['project']);
            request.project = defaultValue1;
