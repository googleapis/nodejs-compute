  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSslPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteSslPolicyRequest', ['sslPolicy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetSslPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetSslPolicyRequest', ['sslPolicy']);
            request.sslPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&ssl_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertSslPolicyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('listAvailableFeatures', () => {
        it('invokes listAvailableFeatures without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAvailableFeaturesSslPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchSslPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchSslPolicyRequest', ['sslPolicy']);
            request.sslPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&ssl_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListSslPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSslPoliciesRequest', ['project']);
            request.project = defaultValue1;
