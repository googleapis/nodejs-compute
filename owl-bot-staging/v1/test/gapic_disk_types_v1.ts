...
describe('v1.DiskTypesClient', () => {
  ...
  afterEach(() => {
    ...
    it('has servicePath', () => {
        const servicePath = disktypesModule.v1.DiskTypesClient.servicePath;
        assert(servicePath);
    });

    it('has apiEndpoint', () => {
        const apiEndpoint = disktypesModule.v1.DiskTypesClient.apiEndpoint;
        assert(apiEndpoint);
    });

    it('has port', () => {
        const port = disktypesModule.v1.DiskTypesClient.port;
        assert(port);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetDiskTypeRequest());
            request.project = '';
            request.zone = '';
            request.diskType = '';
            const expectedHeaderRequestParams = "project=&zone=&disk_type=";
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.DiskType());
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const expectedResponse = [
              ['tuple_key_1', generateSampleMessage(new protos.google.cloud.compute.v1.DiskTypesScopedList())],
              ['tuple_key_2', generateSampleMessage(new protos.google.cloud.compute.v1.DiskTypesScopedList())],
              ['tuple_key_3', generateSampleMessage(new protos.google.cloud.compute.v1.DiskTypesScopedList())],
            ];
            client.descriptors.page.aggregatedList.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: Array<[string, protos.google.cloud.compute.v1.IDiskTypesScopedList]> = [];
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListDiskTypesRequest());
            request.project = '';
            request.zone = '';
