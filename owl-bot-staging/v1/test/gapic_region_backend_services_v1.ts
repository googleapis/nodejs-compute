  ...
  afterEach(() => {
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetRegionBackendServiceRequest());
            request.project = '';
            request.region = '';
            request.backendService = '';
            const expectedHeaderRequestParams = "project=&region=&backend_service=";
    ...
    describe('getHealth', () => {
        it('invokes getHealth without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetHealthRegionBackendServiceRequest());
            request.project = '';
            request.region = '';
            request.backendService = '';
            const expectedHeaderRequestParams = "project=&region=&backend_service=";
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetIamPolicyRegionBackendServiceRequest());
            request.project = '';
            request.region = '';
            request.resource = '';
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchRegionBackendServiceRequest());
            request.project = '';
            request.region = '';
            request.backendService = '';
            const expectedHeaderRequestParams = "project=&region=&backend_service=";
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetIamPolicyRegionBackendServiceRequest());
            request.project = '';
            request.region = '';
            request.resource = '';
            const expectedHeaderRequestParams = "project=&region=&resource=";
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.UpdateRegionBackendServiceRequest());
            request.project = '';
            request.region = '';
            request.backendService = '';
            const expectedHeaderRequestParams = "project=&region=&backend_service=";
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListRegionBackendServicesRequest());
            request.project = '';
            request.region = '';
            const expectedHeaderRequestParams = "project=&region=";
            const expectedOptions = {
