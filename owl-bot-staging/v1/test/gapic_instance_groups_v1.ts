  ...
  afterEach(() => {
    ...
    describe('addInstances', () => {
        it('invokes addInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddInstancesInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddInstancesInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('AddInstancesInstanceGroupRequest', ['instanceGroup']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&instance_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&instance_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
    ...
    describe('removeInstances', () => {
        it('invokes removeInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveInstancesInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemoveInstancesInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RemoveInstancesInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&instance_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setNamedPorts', () => {
        it('invokes setNamedPorts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetNamedPortsInstanceGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetNamedPortsInstanceGroupRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetNamedPortsInstanceGroupRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}&instance_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListInstanceGroupsRequest', ['zone']);
            request.zone = defaultValue2;
    ...
    describe('listInstances', () => {
        it('invokes listInstances without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListInstancesInstanceGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListInstancesInstanceGroupsRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('ListInstancesInstanceGroupsRequest', ['instanceGroup']);
            request.instanceGroup = defaultValue3;
