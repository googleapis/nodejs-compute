...
describe('v1.AcceleratorTypesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = acceleratortypesModule.v1.AcceleratorTypesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = acceleratortypesModule.v1.AcceleratorTypesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = acceleratortypesModule.v1.AcceleratorTypesClient.port;
            assert(port);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetAcceleratorTypeRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetAcceleratorTypeRequest', ['zone']);
            request.zone = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetAcceleratorTypeRequest', ['acceleratorType']);
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.IAcceleratorType|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListAcceleratorTypesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = [
              ['tuple_key_1', generateSampleMessage(new protos.google.cloud.compute.v1.AcceleratorTypesScopedList())],
              ['tuple_key_2', generateSampleMessage(new protos.google.cloud.compute.v1.AcceleratorTypesScopedList())],
              ['tuple_key_3', generateSampleMessage(new protos.google.cloud.compute.v1.AcceleratorTypesScopedList())],
            ];
            client.descriptors.page.aggregatedList.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: Array<[string, protos.google.cloud.compute.v1.IAcceleratorTypesScopedList]> = [];
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListAcceleratorTypesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListAcceleratorTypesRequest', ['zone']);
            request.zone = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&zone=${defaultValue2}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.AcceleratorType()),
              generateSampleMessage(new protos.google.cloud.compute.v1.AcceleratorType()),
              generateSampleMessage(new protos.google.cloud.compute.v1.AcceleratorType()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.AcceleratorType[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.AcceleratorType) => {
        ...
        it('uses async iteration with list without error', async () => {
            ...
            const responses: protos.google.cloud.compute.v1.IAcceleratorType[] = [];
