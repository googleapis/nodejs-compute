  ...
  afterEach(() => {
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.InsertRegionSslPolicyRequest());
            request.project = '';
            request.region = '';
    ...
    describe('listAvailableFeatures', () => {
        it('invokes listAvailableFeatures without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListAvailableFeaturesRegionSslPoliciesRequest());
            request.project = '';
            request.region = '';
            const expectedHeaderRequestParams = "project=&region=";
            const expectedOptions = {
