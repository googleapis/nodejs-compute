  ...
  afterEach(() => {
    ...
    describe('addRule', () => {
        it('invokes addRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddRuleSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddRuleSecurityPolicyRequest', ['securityPolicy']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&security_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&security_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRule', () => {
        it('invokes getRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRuleSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetRuleSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&security_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('listPreconfiguredExpressionSets', () => {
        it('invokes listPreconfiguredExpressionSets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPreconfiguredExpressionSetsSecurityPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&security_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('patchRule', () => {
        it('invokes patchRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchRuleSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchRuleSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&security_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('removeRule', () => {
        it('invokes removeRule without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveRuleSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemoveRuleSecurityPolicyRequest', ['securityPolicy']);
            request.securityPolicy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&security_policy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetLabelsSecurityPolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetLabelsSecurityPolicyRequest', ['resource']);
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListSecurityPoliciesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSecurityPoliciesRequest', ['project']);
            request.project = defaultValue1;
