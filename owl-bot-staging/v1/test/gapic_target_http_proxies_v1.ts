...
describe('v1.TargetHttpProxiesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = targethttpproxiesModule.v1.TargetHttpProxiesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = targethttpproxiesModule.v1.TargetHttpProxiesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = targethttpproxiesModule.v1.TargetHttpProxiesClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new targethttpproxiesModule.v1.TargetHttpProxiesClient();
            assert(client);
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetHttpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteTargetHttpProxyRequest', ['targetHttpProxy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetHttpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTargetHttpProxyRequest', ['targetHttpProxy']);
            request.targetHttpProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_http_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertTargetHttpProxyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchTargetHttpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchTargetHttpProxyRequest', ['targetHttpProxy']);
            request.targetHttpProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_http_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setUrlMap', () => {
        it('invokes setUrlMap without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetUrlMapTargetHttpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetUrlMapTargetHttpProxyRequest', ['targetHttpProxy']);
            request.targetHttpProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_http_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListTargetHttpProxiesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
            const expectedResponse = [
              ['tuple_key_1', generateSampleMessage(new protos.google.cloud.compute.v1.TargetHttpProxiesScopedList())],
              ['tuple_key_2', generateSampleMessage(new protos.google.cloud.compute.v1.TargetHttpProxiesScopedList())],
              ['tuple_key_3', generateSampleMessage(new protos.google.cloud.compute.v1.TargetHttpProxiesScopedList())],
            ];
            client.descriptors.page.aggregatedList.asyncIterate = stubAsyncIterationCall(expectedResponse);
            const responses: Array<[string, protos.google.cloud.compute.v1.ITargetHttpProxiesScopedList]> = [];
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetHttpProxiesRequest', ['project']);
            request.project = defaultValue1;
