  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteTargetHttpProxyRequest());
            request.project = '';
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetTargetHttpProxyRequest());
            request.project = '';
            request.targetHttpProxy = '';
            const expectedHeaderRequestParams = "project=&target_http_proxy=";
            const expectedOptions = {
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.InsertTargetHttpProxyRequest());
            request.project = '';
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchTargetHttpProxyRequest());
            request.project = '';
            request.targetHttpProxy = '';
            const expectedHeaderRequestParams = "project=&target_http_proxy=";
            const expectedOptions = {
    ...
    describe('setUrlMap', () => {
        it('invokes setUrlMap without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetUrlMapTargetHttpProxyRequest());
            request.project = '';
            request.targetHttpProxy = '';
            const expectedHeaderRequestParams = "project=&target_http_proxy=";
            const expectedOptions = {
