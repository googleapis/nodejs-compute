  ...
  afterEach(() => {
    ...
    describe('attachNetworkEndpoints', () => {
        it('invokes attachNetworkEndpoints without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&zone=&network_endpoint_group=";
    ...
    describe('listNetworkEndpoints', () => {
        ...
        it('uses async iteration with listNetworkEndpoints with error', async () => {
            ...
            request.zone = '';
            request.networkEndpointGroup = '';
            const expectedHeaderRequestParams = "project=&zone=&network_endpoint_group=";const expectedError = new Error('expected');
