  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteRegionSecurityPolicyRequest());
            request.project = '';
            request.region = '';
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetRegionSecurityPolicyRequest());
            request.project = '';
            request.region = '';
            request.securityPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&security_policy=";
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchRegionSecurityPolicyRequest());
            request.project = '';
            request.region = '';
            request.securityPolicy = '';
            const expectedHeaderRequestParams = "project=&region=&security_policy=";
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.ListRegionSecurityPoliciesRequest());
            request.project = '';
            request.region = '';
            const expectedHeaderRequestParams = "project=&region=";
            const expectedOptions = {
