  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&region=&target_vpn_gateway=";
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetLabelsTargetVpnGatewayRequest());
            request.project = '';
            request.region = '';
            request.resource = '';
