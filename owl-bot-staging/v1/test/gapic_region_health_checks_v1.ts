  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRegionHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteRegionHealthCheckRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteRegionHealthCheckRequest', ['healthCheck']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRegionHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetRegionHealthCheckRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetRegionHealthCheckRequest', ['healthCheck']);
            request.healthCheck = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&health_check=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertRegionHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertRegionHealthCheckRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchRegionHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchRegionHealthCheckRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('PatchRegionHealthCheckRequest', ['healthCheck']);
            request.healthCheck = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&health_check=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateRegionHealthCheckRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateRegionHealthCheckRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('UpdateRegionHealthCheckRequest', ['healthCheck']);
            request.healthCheck = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&health_check=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRegionHealthChecksRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListRegionHealthChecksRequest', ['region']);
            request.region = defaultValue2;
