  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteGlobalOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteGlobalOperationRequest', ['operation']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetGlobalOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetGlobalOperationRequest', ['operation']);
            request.operation = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&operation=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('wait', () => {
        it('invokes wait without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('WaitGlobalOperationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('WaitGlobalOperationRequest', ['operation']);
            request.operation = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&operation=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListGlobalOperationsRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListGlobalOperationsRequest', ['project']);
            request.project = defaultValue1;
