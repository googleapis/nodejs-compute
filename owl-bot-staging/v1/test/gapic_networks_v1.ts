  ...
  afterEach(() => {
    ...
    describe('addPeering', () => {
        it('invokes addPeering without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddPeeringNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddPeeringNetworkRequest', ['network']);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getEffectiveFirewalls', () => {
        it('invokes getEffectiveFirewalls without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetEffectiveFirewallsNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetEffectiveFirewallsNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertNetworkRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('removePeering', () => {
        it('invokes removePeering without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemovePeeringNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemovePeeringNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('switchToCustomMode', () => {
        it('invokes switchToCustomMode without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SwitchToCustomModeNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SwitchToCustomModeNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('updatePeering', () => {
        it('invokes updatePeering without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdatePeeringNetworkRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdatePeeringNetworkRequest', ['network']);
            request.network = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&network=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListNetworksRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('listPeeringRoutes', () => {
        it('invokes listPeeringRoutes without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListPeeringRoutesNetworksRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListPeeringRoutesNetworksRequest', ['network']);
            request.network = defaultValue2;
