  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteUrlMapRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteUrlMapRequest', ['urlMap']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetUrlMapRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetUrlMapRequest', ['urlMap']);
            request.urlMap = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&url_map=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertUrlMapRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('invalidateCache', () => {
        it('invokes invalidateCache without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InvalidateCacheUrlMapRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InvalidateCacheUrlMapRequest', ['urlMap']);
            request.urlMap = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&url_map=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchUrlMapRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchUrlMapRequest', ['urlMap']);
            request.urlMap = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&url_map=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('update', () => {
        it('invokes update without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateUrlMapRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('UpdateUrlMapRequest', ['urlMap']);
            request.urlMap = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&url_map=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('validate', () => {
        it('invokes validate without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ValidateUrlMapRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ValidateUrlMapRequest', ['urlMap']);
            request.urlMap = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&url_map=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListUrlMapsRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListUrlMapsRequest', ['project']);
            request.project = defaultValue1;
