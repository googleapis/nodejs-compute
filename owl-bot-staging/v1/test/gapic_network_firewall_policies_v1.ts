  ...
  afterEach(() => {
    ...
    describe('addAssociation', () => {
        it('invokes addAssociation without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            ...
            assert((client.innerApiCalls.addAssociation as SinonStub)
    ...
    describe('addRule', () => {
        it('invokes addRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.AddRuleNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
    ...
    describe('cloneRules', () => {
        it('invokes cloneRules without error', async () => {
            ...
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            assert((client.innerApiCalls.cloneRules as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.DeleteNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.FirewallPolicy());
    ...
    describe('getAssociation', () => {
        it('invokes getAssociation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetAssociationNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.FirewallPolicyAssociation());
            client.innerApiCalls.getAssociation = stubSimpleCall(expectedResponse);
            const [response] = await client.getAssociation(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getAssociation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.GetIamPolicyNetworkFirewallPolicyRequest());
            request.project = '';
            request.resource = '';
    ...
    describe('getRule', () => {
        it('invokes getRule without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.compute.v1.FirewallPolicyRule());
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.InsertNetworkFirewallPolicyRequest());
            request.project = '';
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
    ...
    describe('patchRule', () => {
        it('invokes patchRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.PatchRuleNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
    ...
    describe('removeAssociation', () => {
        it('invokes removeAssociation without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.RemoveAssociationNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
            ...
            assert.deepStrictEqual(response.latestResponse, expectedResponse);
            assert((client.innerApiCalls.removeAssociation as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('removeRule', () => {
        it('invokes removeRule without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.RemoveRuleNetworkFirewallPolicyRequest());
            request.project = '';
            request.firewallPolicy = '';
            const expectedHeaderRequestParams = "project=&firewall_policy=";
            const expectedOptions = {
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetIamPolicyNetworkFirewallPolicyRequest());
            request.project = '';
            request.resource = '';
            const expectedHeaderRequestParams = "project=&resource=";
            const expectedOptions = {
