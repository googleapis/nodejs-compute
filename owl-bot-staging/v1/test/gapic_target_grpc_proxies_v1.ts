...
describe('v1.TargetGrpcProxiesClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = targetgrpcproxiesModule.v1.TargetGrpcProxiesClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = targetgrpcproxiesModule.v1.TargetGrpcProxiesClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = targetgrpcproxiesModule.v1.TargetGrpcProxiesClient.port;
            assert(port);
            assert(typeof port === 'number');
        });

        it('should create a client with no option', () => {
            const client = new targetgrpcproxiesModule.v1.TargetGrpcProxiesClient();
            assert(client);
        });
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetGrpcProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteTargetGrpcProxyRequest', ['targetGrpcProxy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetGrpcProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTargetGrpcProxyRequest', ['targetGrpcProxy']);
            request.targetGrpcProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_grpc_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.TargetGrpcProxy()
            );
        ...
        it('invokes get without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.get(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.compute.v1.ITargetGrpcProxy|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertTargetGrpcProxyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchTargetGrpcProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchTargetGrpcProxyRequest', ['targetGrpcProxy']);
            request.targetGrpcProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_grpc_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetGrpcProxiesRequest', ['project']);
            request.project = defaultValue1;
            const expectedHeaderRequestParams = `project=${defaultValue1}`;const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.compute.v1.TargetGrpcProxy()),
              generateSampleMessage(new protos.google.cloud.compute.v1.TargetGrpcProxy()),
              generateSampleMessage(new protos.google.cloud.compute.v1.TargetGrpcProxy()),
            ];
        ...
        it('invokes listStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                const responses: protos.google.cloud.compute.v1.TargetGrpcProxy[] = [];
                stream.on('data', (response: protos.google.cloud.compute.v1.TargetGrpcProxy) => {
