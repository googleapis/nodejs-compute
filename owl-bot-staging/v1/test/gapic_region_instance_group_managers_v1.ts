  ...
  afterEach(() => {
    ...
    describe('abandonInstances', () => {
        it('invokes abandonInstances without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&region=&instance_group_manager=";
    ...
    describe('listErrors', () => {
        ...
        it('uses async iteration with listErrors with error', async () => {
            ...
            request.region = '';
            request.instanceGroupManager = '';
            const expectedHeaderRequestParams = "project=&region=&instance_group_manager=";const expectedError = new Error('expected');
