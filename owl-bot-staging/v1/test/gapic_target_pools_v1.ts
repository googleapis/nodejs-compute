  ...
  afterEach(() => {
    ...
    describe('addHealthCheck', () => {
        it('invokes addHealthCheck without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddHealthCheckTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddHealthCheckTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('AddHealthCheckTargetPoolRequest', ['targetPool']);
    ...
    describe('addInstance', () => {
        it('invokes addInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AddInstanceTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('AddInstanceTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('AddInstanceTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getHealth', () => {
        it('invokes getHealth without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetHealthTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetHealthTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetHealthTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertTargetPoolRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('removeHealthCheck', () => {
        it('invokes removeHealthCheck without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveHealthCheckTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemoveHealthCheckTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RemoveHealthCheckTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('removeInstance', () => {
        it('invokes removeInstance without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('RemoveInstanceTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('RemoveInstanceTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('RemoveInstanceTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setBackup', () => {
        it('invokes setBackup without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetBackupTargetPoolRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetBackupTargetPoolRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetBackupTargetPoolRequest', ['targetPool']);
            request.targetPool = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&target_pool=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListTargetPoolsRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetPoolsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListTargetPoolsRequest', ['region']);
            request.region = defaultValue2;
