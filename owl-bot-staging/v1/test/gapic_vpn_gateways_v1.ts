  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteVpnGatewayRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteVpnGatewayRequest', ['vpnGateway']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetVpnGatewayRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetVpnGatewayRequest', ['vpnGateway']);
            request.vpnGateway = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&vpn_gateway=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getStatus', () => {
        it('invokes getStatus without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetStatusVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetStatusVpnGatewayRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetStatusVpnGatewayRequest', ['vpnGateway']);
            request.vpnGateway = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&vpn_gateway=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertVpnGatewayRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetLabelsVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetLabelsVpnGatewayRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetLabelsVpnGatewayRequest', ['resource']);
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TestIamPermissionsVpnGatewayRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('TestIamPermissionsVpnGatewayRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('TestIamPermissionsVpnGatewayRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListVpnGatewaysRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListVpnGatewaysRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListVpnGatewaysRequest', ['region']);
            request.region = defaultValue2;
