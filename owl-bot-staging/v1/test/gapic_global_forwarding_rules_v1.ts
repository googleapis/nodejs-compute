  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteGlobalForwardingRuleRequest', ['forwardingRule']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&forwarding_rule=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&forwarding_rule=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetLabelsGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetLabelsGlobalForwardingRuleRequest', ['resource']);
    ...
    describe('setTarget', () => {
        it('invokes setTarget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetTargetGlobalForwardingRuleRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetTargetGlobalForwardingRuleRequest', ['forwardingRule']);
            request.forwardingRule = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&forwarding_rule=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListGlobalForwardingRulesRequest', ['project']);
            request.project = defaultValue1;
