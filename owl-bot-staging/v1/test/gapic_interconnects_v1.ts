  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteInterconnectRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteInterconnectRequest', ['interconnect']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetInterconnectRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetInterconnectRequest', ['interconnect']);
            request.interconnect = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&interconnect=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getDiagnostics', () => {
        it('invokes getDiagnostics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetDiagnosticsInterconnectRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetDiagnosticsInterconnectRequest', ['interconnect']);
            request.interconnect = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&interconnect=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertInterconnectRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('patch', () => {
        it('invokes patch without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PatchInterconnectRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('PatchInterconnectRequest', ['interconnect']);
            request.interconnect = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&interconnect=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetLabelsInterconnectRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetLabelsInterconnectRequest', ['resource']);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListInterconnectsRequest', ['project']);
            request.project = defaultValue1;
