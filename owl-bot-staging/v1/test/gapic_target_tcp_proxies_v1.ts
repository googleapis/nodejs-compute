  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetTcpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteTargetTcpProxyRequest', ['targetTcpProxy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetTcpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetTargetTcpProxyRequest', ['targetTcpProxy']);
            request.targetTcpProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_tcp_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertTargetTcpProxyRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('setBackendService', () => {
        it('invokes setBackendService without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetBackendServiceTargetTcpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetBackendServiceTargetTcpProxyRequest', ['targetTcpProxy']);
            request.targetTcpProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_tcp_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('setProxyHeader', () => {
        it('invokes setProxyHeader without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetProxyHeaderTargetTcpProxyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetProxyHeaderTargetTcpProxyRequest', ['targetTcpProxy']);
            request.targetTcpProxy = defaultValue2;
            const expectedHeaderRequestParams = `project=${defaultValue1}&target_tcp_proxy=${defaultValue2}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Operation()
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetTcpProxiesRequest', ['project']);
            request.project = defaultValue1;
