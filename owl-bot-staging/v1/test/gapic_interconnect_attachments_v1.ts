  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const expectedHeaderRequestParams = "project=&region=&interconnect_attachment=";
    ...
    describe('setLabels', () => {
        it('invokes setLabels without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.compute.v1.SetLabelsInterconnectAttachmentRequest());
            request.project = '';
            request.region = '';
            request.resource = '';
