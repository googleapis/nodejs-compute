  ...
  afterEach(() => {
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteResourcePolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteResourcePolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteResourcePolicyRequest', ['resourcePolicy']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetResourcePolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetResourcePolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetResourcePolicyRequest', ['resourcePolicy']);
            request.resourcePolicy = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&resource_policy=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getIamPolicy', () => {
        it('invokes getIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetIamPolicyResourcePolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetIamPolicyResourcePolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetIamPolicyResourcePolicyRequest', ['resource']);
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertResourcePolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertResourcePolicyRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('setIamPolicy', () => {
        it('invokes setIamPolicy without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SetIamPolicyResourcePolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('SetIamPolicyResourcePolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('SetIamPolicyResourcePolicyRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.cloud.compute.v1.Policy()
    ...
    describe('testIamPermissions', () => {
        it('invokes testIamPermissions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('TestIamPermissionsResourcePolicyRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('TestIamPermissionsResourcePolicyRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('TestIamPermissionsResourcePolicyRequest', ['resource']);
            request.resource = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&resource=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('aggregatedList', () => {
        ...
        it('uses async iteration with aggregatedList without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AggregatedListResourcePoliciesRequest', ['project']);
            request.project = defaultValue1;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListResourcePoliciesRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListResourcePoliciesRequest', ['region']);
            request.region = defaultValue2;
