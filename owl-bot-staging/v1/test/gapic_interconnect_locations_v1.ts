  ...
  afterEach(() => {
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetInterconnectLocationRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetInterconnectLocationRequest', ['interconnectLocation']);
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListInterconnectLocationsRequest', ['project']);
            request.project = defaultValue1;
