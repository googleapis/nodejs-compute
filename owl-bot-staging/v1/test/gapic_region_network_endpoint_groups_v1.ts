...
describe('v1.RegionNetworkEndpointGroupsClient', () => {
  ...
  afterEach(() => {
    ...
    describe('Common methods', () => {
        it('has servicePath', () => {
            const servicePath = regionnetworkendpointgroupsModule.v1.RegionNetworkEndpointGroupsClient.servicePath;
            assert(servicePath);
        });

        it('has apiEndpoint', () => {
            const apiEndpoint = regionnetworkendpointgroupsModule.v1.RegionNetworkEndpointGroupsClient.apiEndpoint;
            assert(apiEndpoint);
        });

        it('has port', () => {
            const port = regionnetworkendpointgroupsModule.v1.RegionNetworkEndpointGroupsClient.port;
            assert(port);
    ...
    describe('delete', () => {
        it('invokes delete without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteRegionNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('DeleteRegionNetworkEndpointGroupRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('DeleteRegionNetworkEndpointGroupRequest', ['networkEndpointGroup']);
    ...
    describe('get', () => {
        it('invokes get without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRegionNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('GetRegionNetworkEndpointGroupRequest', ['region']);
            request.region = defaultValue2;
            const defaultValue3 =
              getTypeDefaultValue('GetRegionNetworkEndpointGroupRequest', ['networkEndpointGroup']);
            request.networkEndpointGroup = defaultValue3;
            const expectedHeaderRequestParams = `project=${defaultValue1}&region=${defaultValue2}&network_endpoint_group=${defaultValue3}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('insert', () => {
        it('invokes insert without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('InsertRegionNetworkEndpointGroupRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('InsertRegionNetworkEndpointGroupRequest', ['region']);
            request.region = defaultValue2;
    ...
    describe('list', () => {
        it('invokes list without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRegionNetworkEndpointGroupsRequest', ['project']);
            request.project = defaultValue1;
            const defaultValue2 =
              getTypeDefaultValue('ListRegionNetworkEndpointGroupsRequest', ['region']);
            request.region = defaultValue2;
